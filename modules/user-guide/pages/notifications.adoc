...
In addition to tags and emojis, native Android supports additional formatting using HTML Lite. The xref:user-guide:reference:page$notification-markup.adoc[Android Notification Text Markup documentation] will help you set up messages using this feature.
