...
== Personalizing the notification content
...
====
If you don't tell the player that they get a reward for tapping — and what that reward is — they won't know. With tiered rewards, each player can see the specific amount they'll receive based on their tier, which makes the notification feel personally relevant rather than generic.
====
