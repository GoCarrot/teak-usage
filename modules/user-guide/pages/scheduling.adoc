...
+
If the schedule has messages for both Push and Email, Teak will send to the iOS or Android device most recently played on, and email will only go to users who do not have a push key.

* *All Devices and Channels*
** Send messages to all devices and channels.
+
