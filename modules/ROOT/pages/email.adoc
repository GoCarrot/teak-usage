...
This is also called a "hidden preheader," by some vendors because of how it's implemented. 
...
The _Large Image Click_ template requires an image to be sent. The image size is mostly up to you, and will be compressed as needed. It’s beneficial to test on different devices and email providers to determine the ideal resolution for your images.
